...
const REALMS: Record<string, IScene> = {
  ...
  mage_b: {
    theme: SceneTheme.CircuitCatacombs,
    label: "Circuit Catacombs",
    monster: "The Kernel Lich",
  },
  ranger_a: { theme: SceneTheme.AuroraFlux, label: "Aurora Flux", monster: "Prism Wisp" },
  ranger_b: {
    theme: SceneTheme.GeometricSanctum,
    label: "Geometric Sanctum",
    monster: "The Grid Warden",
  },
  rogue_a: {
    theme: SceneTheme.QuantumRift,
    label: "Quantum Rift",
    monster: "The Heisenbug",
  },
  rogue_b: {
    theme: SceneTheme.NoirCrimeScene,
    label: "Noir Crime Scene",
    monster: "The Phantom Culprit",
  },
  sage_a: {
    theme: SceneTheme.OraclesAthenaeum,
    label: "Oracle's Athenaeum",
    monster: "The Domain Sphinx",
  },
  sage_b: {
    theme: SceneTheme.ConductorsNexus,
    label: "Conductor's Nexus",
    monster: "The Orchestration Construct",
  },
  maestro: {
    theme: SceneTheme.GrandConcertVault,
    label: "Grand Concert Vault",
    monster: "The Living Symphony",
  },
  night_owl: {
  ...
  ascetic: {
    theme: SceneTheme.SilentSummit,
    label: "Silent Summit",
    monster: "The Stone Guardian",
  },
  gremlin: {
    theme: SceneTheme.GlitchPit,
    label: "The Glitch Pit",
    monster: "The Chaos Gremlin King",
  },
  trickster: {
    theme: SceneTheme.FoolsMirage,
    label: "Fool's Mirage",
    monster: "The Jester Mirage",
  },
};
