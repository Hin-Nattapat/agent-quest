...
> idle/attack ของทั้ง 3 ตัว = Action Description กลางใน §7.A · import: `bun tools/import-art.ts <export> --as monster:grassland` (grassland/forest/dungeon) + `--as bg:grassland` สำหรับรูปฉาก
