...
- 🖼️ scene: `a side-view pixel-art battle background of a grassy meadow outside a town, bright green field, clear blue sky, distant town walls, the ground line in the lower third, no characters, cheerful, limited palette, clean pixel art, slightly stylized`
...
- 🖼️ scene: `a side-view pixel-art battle background of a dark whispering forest, deep green foliage, drifting fog, dim light filtering through the canopy, the ground line in the lower third, no characters, eerie, limited palette, clean pixel art, slightly stylized`
...
- 🖼️ scene: `a side-view pixel-art battle background of a deep stone dungeon, grey brick walls, flickering wall torches, heavy shadows, the ground line in the lower third, no characters, oppressive, limited palette, clean pixel art, slightly stylized`
