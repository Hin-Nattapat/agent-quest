...
> ⚠️ **ของประดับพหูพจน์ = โดนปูเป็นแถว** — "tall mirrors at the edges" ได้กระจกเรียงลึกเข้ากลางฉาก (Fools Mirage โดนมาแล้ว 2026-07). ระบุ**จำนวนต่อข้าง**ตรง ๆ: `a single ... at the far left edge only` + ซ้ำอีกประโยคฝั่งขวา. เรื่องสำคัญ (ฟ้ากลางคืน/รุ้ง) วาง**ต้น prompt** — ท้าย prompt โดนเมิน; พื้นต้องเกลี้ยงให้พูดบวก `the floor completely bare and clean`.
...
```
a side-view pixel-art battle background of a serene mountain monastery summit high above the clouds, a wide open flat pale stone terrace floor across the entire lower third, the floor completely bare and clean with nothing scattered on it, the foreground level, clear and unobstructed with open ground on both the left and right, one simple stone lantern and a small stone stupa at the far left edge only, a single bare windswept tree and one stone lantern at the far right edge only, the curved rooftop of a small minimalist monastery hall faintly visible in the misty background between them, distant pale mountain peaks rising above a sea of soft clouds behind, thin drifting mist and a few faint softly glowing white glyphs floating high in the air, completely empty with no people, no characters, no creatures, no figures, off-white and pale stone with a hint of warm morning light, calm and minimalist zen atmosphere, limited palette, clean pixel art, slightly stylized
```
`glitch_pit` (Gremlin · The Glitch Pit)
```
a side-view pixel-art battle background of a corrupted digital glitch pit deep underground, a giant glowing toxic-green waterfall of falling code streaming down the dark background wall in the far distance, a wide open flat dark cracked-stone floor across the entire lower third, the floor completely bare and clean with nothing scattered on it, the foreground level, clear and unobstructed with open floor on both the left and right, one giant cracked broken computer monitor with a flickering green screen half-buried at the far left edge, a single leaning tower of stacked broken server racks sparking at the far right edge, a few small glitching pixel-blocks and datamosh streaks floating high in the dark air, completely empty with no people, no characters, no creatures, no figures, dark stone with toxic-green glitch glow confined to the background, eerie and unstable, limited palette, clean pixel art, slightly stylized
```
`fools_mirage` (Trickster · Fool's Mirage)
```
a side-view pixel-art battle background of a whimsical illusion carnival under a bright hazy dreamlike daytime sky, colorful triangular bunting pennant garlands strung high across the sky, a large striped carnival big-top tent with a small waving flag filling the far left edge, a tall ornate gold-framed mirror standing in front of the left tent, a large striped carnival big-top tent with a small waving flag filling the far right edge, a tall ornate gold-framed mirror standing in front of the right tent, faint dreamy silhouettes of distant carnival tents and a carousel shimmering like a mirage in the hazy background between them, soft cream and pastel clouds glowing with a gentle pearlescent shimmer, a wide open flat checkered harlequin-tile floor across the entire lower third in slightly deeper dusty pastel tones than the pale sky, the floor completely bare and clean with nothing scattered on it, the foreground level, clear and unobstructed with open ground on both the left and right, a few small drifting playing cards high in the sky, completely empty with no people, no characters, no creatures, no figures, soft mother-of-pearl pastel palette with a dreamy sunlit haze, whimsical and dreamlike, limited palette, clean pixel art, slightly stylized
```
