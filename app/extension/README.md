...
> **Needs the Agent Quest engine.** This panel renders `~/.agentrpg/state.json`, which the Commit
...
> <https://github.com/Hin-Nattapat/agent-quest#install>

## Usage

1. Install this extension (Marketplace) and reload the window.
2. Open the **Agent Quest** panel — it sits next to Terminal / Output in the bottom panel.
...
[`docs/reference/publishing.md`](https://github.com/Hin-Nattapat/agent-quest/blob/main/docs/reference/publishing.md).

## License

[MIT](https://github.com/Hin-Nattapat/agent-quest/blob/main/LICENSE)
